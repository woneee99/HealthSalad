...
import com.example.banksalad.utils.Keys;
...
public class CalendarListViewModel extends ViewModel {
    ...
    public void setTitle(long time) {
        mCurrentTime = time;
        mTitle.setValue(com.example.banksalad.utils.DateFormat.getDate(time, com.example.banksalad.utils.DateFormat.CALENDAR_HEADER_FORMAT));
    }
