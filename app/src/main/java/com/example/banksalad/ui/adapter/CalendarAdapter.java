package com.example.banksalad.ui.adapter;
...
import com.example.banksalad.databinding.CalendarHeaderBinding;
import com.example.banksalad.databinding.DayItemBinding;
import com.example.banksalad.databinding.EmptyDayBinding;
import com.example.banksalad.ui.viewmodel.CalendarHeaderViewModel;
import com.example.banksalad.ui.viewmodel.CalendarViewModel;
import com.example.banksalad.ui.viewmodel.EmptyViewModel;
...
public class CalendarAdapter extends ListAdapter<Object, RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == HEADER_TYPE) { // 날짜 타입
            CalendarHeaderBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.activity_item_calendar_header, parent, false);
            ...
            EmptyDayBinding binding =
                    DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.activity_item_day_empty, parent, false);
            return new EmptyViewHolder(binding);
        }
        DayItemBinding binding =
                DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.activity_item_day, parent, false);// 일자 타입
